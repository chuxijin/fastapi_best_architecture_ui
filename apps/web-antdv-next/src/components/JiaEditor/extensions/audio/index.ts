...
import { BlockActionSeparator } from "#/components/JiaEditor/components";
import MingcuteDelete2Line from "#/components/JiaEditor/components/icon/MingcuteDelete2Line.vue";
import ToolboxItem from "#/components/JiaEditor/components/toolbox/ToolboxItem.vue";
...
import {
  ...
  VueNodeViewRenderer,
  type Range,
} from "#/components/JiaEditor/tiptap";
import type { EditorState } from "#/components/JiaEditor/tiptap/pm";
import type { ExtensionOptions, NodeBubbleMenuType } from "#/components/JiaEditor/types";
import { deleteNode } from "#/components/JiaEditor/utils";
...
declare module "#/components/JiaEditor/tiptap" {
