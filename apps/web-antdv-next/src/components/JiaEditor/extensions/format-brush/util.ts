import type { EditorState, MarkRange, Transaction } from "#/components/JiaEditor/tiptap";
import { AddMarkStep, CellSelection, RemoveMarkStep } from "#/components/JiaEditor/tiptap/pm";
