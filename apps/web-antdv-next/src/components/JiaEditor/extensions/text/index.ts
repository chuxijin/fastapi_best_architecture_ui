...
import BlockActionSeparator from "#/components/JiaEditor/components/block/BlockActionSeparator.vue";
import ColorBubbleItem from "#/components/JiaEditor/extensions/color/ColorBubbleItem.vue";
import HighlightBubbleItem from "#/components/JiaEditor/extensions/highlight/HighlightBubbleItem.vue";
import LinkBubbleButton from "#/components/JiaEditor/extensions/link/LinkBubbleButton.vue";
import { RangeSelection } from "#/components/JiaEditor/extensions/range-selection";
import { i18n } from "#/components/JiaEditor/locales";
import { PluginKey, type EditorState } from "#/components/JiaEditor/tiptap/pm";
import { isActive, isTextSelection } from "#/components/JiaEditor/tiptap/vue-3";
import type { ExtensionOptions, NodeBubbleMenuType } from "#/components/JiaEditor/types";
