import type { EditorState, Rect, Selection, Transaction } from "#/components/JiaEditor/tiptap/pm";
import { CellSelection, Node, selectedRect, TableMap } from "#/components/JiaEditor/tiptap/pm";
import { findParentNode } from "#/components/JiaEditor/tiptap/vue-3";
