...
import { EditorLinkObtain } from "#/components/JiaEditor/components";
import { ResourceReplaceButton } from "#/components/JiaEditor/components/upload";
import { useExternalAssetsTransfer } from "#/components/JiaEditor/composables/use-attachment";
...
import { fileToBase64 } from "#/components/JiaEditor/utils/upload";
