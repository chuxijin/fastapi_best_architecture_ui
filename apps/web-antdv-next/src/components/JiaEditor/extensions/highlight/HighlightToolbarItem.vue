...
import { ToolbarItem } from "#/components/JiaEditor/components";
import ColorPickerDropdown from "#/components/JiaEditor/components/common/ColorPickerDropdown.vue";
import { i18n } from "#/components/JiaEditor/locales";
import type { ToolbarItemComponentProps } from "#/components/JiaEditor/types";
