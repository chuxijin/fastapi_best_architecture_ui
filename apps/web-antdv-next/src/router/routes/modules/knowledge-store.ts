        ...
        children: [
          {
            ...
            component: () =>
              import('#/views/knowledge-store/resource/question-bank/index.vue'),
            meta: {
              title: '题库管理',
          ...
          },
          {
            ...
            component: () =>
              import('#/views/knowledge-store/resource/question-bank/operation/index.vue'),
            meta: {
              title: '题库运营',
              hideInMenu: true,
              activeMenu: '/knowledge-store/resource/question-bank',
          ...
          },
          {
            ...
            component: () =>
              import('#/views/knowledge-store/resource/material-package/index.vue'),
            meta: {
              title: '资料包管理',
